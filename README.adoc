...
The `lint_yaml` GitHub Actions workflow will check if your YAML files are
properly normalized and will fail if they are not.

If this happens, you will receive a comment on your PR with instructions on how
to fix the issue.
